  ...
  integrations: [
    ...
    sitemap({
      ...
      customPages: [
        ...
        'https://polgubau.com/about',
        'https://polgubau.com/ui',
      ],
      serialize(item) {
        // Homepage - Maximum priority, crawled daily
        if (item.url === 'https://polgubau.com/') {
          item.priority = 1.0;
          item.changefreq = 'daily';
        }
        // About page - High priority for personal branding
        else if (item.url === 'https://polgubau.com/about') {
          item.priority = 0.9;
