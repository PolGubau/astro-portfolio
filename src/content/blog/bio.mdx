...
I started my career as graphic designer aimed by my <strong>Arts & Design</strong> degree where I worked for a few assignments during my high
...
<div className="gap-4 flex overflow-x-auto rounded-xl">
  <img
    ...
    alt="My design that won the 2020 agenda for my highschool"
        src="src/assets/media/other/agenda.png"
     width={300}
    height={200}
  />
  ...
  <img
    className="rounded-xl h-[300px] w-full bg-primary/10 object-contain"
    alt="My design that won the 2020 agenda for my highschool"
    src="../../assets/media/other/santaCecilia.png"
    width={150}
    height={200}
  />
  <img
    className="rounded-xl h-[300px] w-full bg-primary/10 object-contain"
    alt="My design that won the 2020 agenda for my highschool"
    src="../../assets/media/other/setmana.png"
    width={200}
    height={200}
  />
</div>
...
<section className="flex gap-4 show-animation">
  <div>
    <img
      ...
      alt="My design that won the 2020 agenda for my highschool"
      src="../../assets/media/other/motorsag/cara.jpg"
      width={200}
      height={200}
    />
  </div>
