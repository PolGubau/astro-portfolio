...
Pol-UI is [open source on GitHub](https://github.com/PolGubau/pol-ui) and live at [ui.polgubau.com](https://ui.polgubau.com) if you want to see how it turned out. You can also read more about the [Pol-UI project](/projects/polui) and the design decisions behind it.

If you want to go deeper on how component APIs scale, I also wrote about [React composition patterns](/blog/component-composition-patterns) - the techniques I wish I had known before building this library.
