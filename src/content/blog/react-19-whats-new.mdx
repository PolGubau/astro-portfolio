...
import entreLineas from "../../assets/media/projects/entre-lineas/home.webp";
...
<figure>
  <Image src={entreLineas} alt="Entre Líneas - the app I migrated to React 19" class="rounded-xl show-animation" width={800} height={500} />
  <figcaption>Entre Líneas - a poetry reader app I built and migrated to React 19 stable.</figcaption>
</figure>
