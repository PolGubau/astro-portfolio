---
title: "TypeScript Generics in React Components: Complete Guide with Examples"
...
import novaHair from "../../assets/media/projects/novahair/choose-service.webp";
...
<figure>
  <Image src={novaHair} alt="NovaHair service selection — built with generic components" class="rounded-xl show-animation" width={800} height={500} />
  <figcaption>NovaHair's service selection UI. Every dropdown and list is powered by a single generic component.</figcaption>
</figure>
