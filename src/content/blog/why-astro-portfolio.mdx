...
import lighthouseScore from "../../assets/media/other/example-portfolio.webp";
...
<figure>
  <Image src={lighthouseScore} alt="Lighthouse 100/100 score on this portfolio" class="rounded-xl show-animation" width={800} height={450} />
  <figcaption>100/100 across all categories. The green scores are real.</figcaption>
</figure>
...
And if this performance obsession sounds familiar, it's the same mindset I applied to [Pol-UI](/projects/polui) — a component library built to be fast and accessible without trade-offs, or to [Les Santes](/projects/les-santes) — a festival app that works offline at venues with no signal.
