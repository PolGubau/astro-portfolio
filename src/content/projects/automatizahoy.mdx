...
summary: "Landing page for an automation consultancy. Conversion-focused copy, scroll animations, and a clean design system — built with Astro and Tailwind for Doscientos' first client."
