...
<div class="grid grid-cols-2 md:grid-cols-4 gap-4 my-8 max-w-full">
  <div class="p-6 rounded-lg border border-neutral-200 text-center">
    ...
    <div class="text-sm text-neutral-600">Performance</div>
  </div>
  <div class="p-6 rounded-lg border border-neutral-200 text-center">
    <div class="text-4xl font-bold text-green-500">100</div>
    <div class="text-sm text-neutral-600">Accessibility</div>
  </div>
  <div class="p-6 rounded-lg border border-neutral-200 text-center">
    <div class="text-4xl font-bold text-green-500">100</div>
    <div class="text-sm text-neutral-600">Best Practices</div>
  </div>
  <div class="p-6 rounded-lg border border-neutral-200 text-center">
    <div class="text-4xl font-bold text-green-500">100</div>
