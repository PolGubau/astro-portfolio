...
I wanted to build something reusable, well-documented, and actually pleasant to use. Not another component dump - a coherent library with a consistent API and real accessibility support. I wrote about the full process - including the mistakes - in [What I learned building a UI library from scratch](/blog/designingLibrary).
...
The component composition patterns I developed for this library are explained in detail in [React Component Composition Patterns](/blog/component-composition-patterns).
