...
<Image
        ...
        width={700}
        height={700}
        className="rounded-xl h-full max-h-[300px] md:max-h-[400px] object-cover show-animation"
      />
  <figcaption className="text-center">Example of the illustrations.</figcaption>
</figure>
...
<figure>
  <Image
    src={pc3}
    alt="Example of game explication"
    width={600}
    height={400}
    className="rounded-xl max-h-[300px] md:max-h-[400px] w-fit show-animation"
  />
  <figcaption>Example of game explication.</figcaption>
...
<figure>
  <Image
    src={phone1}
    alt="Example of phone view"
    width={600}
    height={400}
    className="rounded-xl max-h-[500px] md:max-h-[600px] w-fit show-animation"
  />
  <figcaption>Example of phone view.</figcaption>
</figure>
