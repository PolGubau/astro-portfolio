...
<ul class="grid pl-0 md:grid-cols-3 gap-4 my-8 max-w-full md:divide-x divide-foreground/20">
  <li class="list-none">
    <strong class="text-3xl font-bold">React 19</strong>
    <div class="text-sm text-foreground/80">Modern stack</div>
  </li>
  <li class="list-none">
    <strong class="text-3xl font-bold ">TanStack Start</strong>
    <div class="text-sm text-foreground/80">SSR framework</div>
  </li>
  <li class="list-none">
    <strong class="text-3xl font-bold ">TypeScript</strong>
    <div class="text-sm text-foreground/80">End-to-end typesafety</div>
  </li>
</ul>
