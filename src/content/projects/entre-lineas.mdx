...
<div class="grid grid-cols-1 md:grid-cols-[1fr_2fr] mt-6 gap-6 items-start">
  <Video 
        src={goNextList}
        class="show-animation"
...
<Image 
  ...
  width={300}
  height={700}
  class="show-animation h-[700px] w-[300px]"
/>
...
<Video 
  src={tooltips}
      ...
      class="show-animation aspect-video"
/>

<Video 
  src={verseAnotations}
      alt="Detailed verse annotations with literary analysis"
      class="show-animation aspect-video mt-6"
/>
...
<Video 
  src={readMode}
        ...
        class="show-animation h-[450px] aspect-video"
...
<Image 
  ...
  alt="Mobile read mode interface"
        width={222}
  height={450}
  class="show-animation object-bottom h-[450px] object-contain"
/>
</div>
---
...
<div class="grid max-md:grid-cols-[1fr_300px] gap-8">
...
<Video 
  ...
  class="show-animation h-[500px] w-[300px] object-contain"
/>
