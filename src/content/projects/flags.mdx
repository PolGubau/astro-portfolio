...
<div className='flex flex-col gap-2 show-animation'>
<Image
    alt="How flags are grouped by type and then alphabetically"
    width={250}
    height={400}
    className="rounded-xl h-full max-h-[300px] object-cover"
    src={Q3}
  />
...
<Image
    ...
    width={550}
    height={400}
    className="rounded-xl h-full max-h-[350px] w-full object-cover"
    src={Q2}
  />
