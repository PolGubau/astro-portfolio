...
summary: "Lightweight TypeScript fuzzy-search library. Zero dependencies, full test coverage, and a live playground - built for developer tools that need fast in-memory search."
