...
summary: "CLI tool that enforces deadlines on TODO and FIXME comments. Fails CI pipelines when overdue comments are found - keeping technical debt visible and actionable."
