export const en = {
  ...
  "home.hero.intro":
    'Senior Frontend Engineer at <a href="https://mesalvo.com" target="_blank" rel="noopener noreferrer" class="text-ink hover:underline underline-offset-4">Mesalvo</a>. Co-founder of <a href="https://doscientos.es" target="_blank" rel="noopener noreferrer" class="text-ink hover:underline underline-offset-4">Doscientos</a>. Based in Mataró, Barcelona.',
  ...
  "home.side.views": "views",
  "home.beyond.title": "Beyond the code",
  ...
  "home.perf.title": "I don't ship slow websites",
  "home.perf.subtitle":
  ...
  "blog.filter.all": "All",
  "blog.filter.empty": "No articles with this tag yet.",
